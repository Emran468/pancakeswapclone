                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 border border-gray-200 mb-4">
                    ...
                    <div className="flex items-center gap-4">
                      <input
                        ...
                        placeholder="0.0"
                        className="flex-1 text-3xl md:text-4xl font-bold bg-transparent border-none outline-none text-gray-900 placeholder-gray-400"
                        step="any"
                        min="0"
                      />
                      {fromToken && (
                        ...
                        >
                          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-pink-400 to-yellow-400 flex items-center justify-center">
                            <span className="text-white font-bold">{fromToken.symbol.charAt(0)}</span>
                          </div>
                        ...
                        {toToken && (
                          ...
                          >
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-purple-400 flex items-center justify-center">
                              <span className="text-white font-bold">{toToken.symbol.charAt(0)}</span>
                            </div>
